...
Board::Board() {
	...
	for (int i = 0; i < 20; i++) {
		for (int j = 0; j < 10; j++) {
			...
			boardShapes[i][j].setPosition((j * 20)+2, (i * 20)+2);
...
bool Board::InstallPart() {
	...
	switch (color) {
	case 1: newPartColor = Color(255, 160, 0); break;
	case 2: newPartColor = Color(240, 150, 240); break;
	case 3: newPartColor = Color(50, 200, 150); break;
	case 4: newPartColor = Color(255, 110, 110); break;
	case 5: newPartColor = Color(255, 200, 70); break;
	case 6: newPartColor = Color(160, 160, 255); break;
	case 7: newPartColor = Color(130, 190, 240); break;
	}
	return true;
}
